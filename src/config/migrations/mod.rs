    ...
    fn all_migrations(&self) -> Vec<Box<dyn MigrationEntry>> {
        vec![
            ...
            Box::new(MigrationEntryV002(
                v002_add_audit_events::V002AddAuditEvents,
            )),
        ]
    }
...
/// Wrapper for V002AddAuditEvents.
struct MigrationEntryV002(v002_add_audit_events::V002AddAuditEvents);
