...
pub const PUBLIC_FERRUM_ENV_SETTINGS: &[&str] = &[
    ...
    "FERRUM_ADMIN_AUDIT_MAX_DELIVERY_ATTEMPTS",
    "FERRUM_ADMIN_AUDIT_QUEUE_CAPACITY",
    "FERRUM_ADMIN_AUDIT_RETAINED_MAX_RECORDS",
    "FERRUM_ADMIN_AUDIT_SPOOL_DIR",
    "FERRUM_ADMIN_AUDIT_SPOOL_MAX_RECORDS",
    "FERRUM_ADMIN_AUDIT_UNAVAILABLE_POLICY",
    "FERRUM_ADMIN_BIND_ADDRESS",
    "FERRUM_ADMIN_BODY_READ_TIMEOUT_SECONDS",
    "FERRUM_ADMIN_HTTP2_MAX_CONCURRENT_STREAMS",
    "FERRUM_ADMIN_HTTP2_MAX_HEADER_LIST_SIZE_BYTES",
    ...
    "FERRUM_ADMIN_SPEC_EXTERNAL_REFS_ALLOWED_ORIGINS",
    "FERRUM_ADMIN_SPEC_EXTERNAL_REFS_ALLOW_HTTP_ORIGINS",
    "FERRUM_ADMIN_SPEC_EXTERNAL_REFS_CONNECT_TIMEOUT_MS",
    "FERRUM_ADMIN_SPEC_EXTERNAL_REFS_ENABLED",
    "FERRUM_ADMIN_SPEC_EXTERNAL_REFS_FILE_ROOT",
    "FERRUM_ADMIN_SPEC_EXTERNAL_REFS_MAX_AGGREGATE_BYTES",
    "FERRUM_ADMIN_SPEC_EXTERNAL_REFS_MAX_DOCUMENTS",
    "FERRUM_ADMIN_SPEC_EXTERNAL_REFS_MAX_DOCUMENT_BYTES",
    "FERRUM_ADMIN_SPEC_EXTERNAL_REFS_MAX_NESTING",
    "FERRUM_ADMIN_SPEC_EXTERNAL_REFS_MAX_REDIRECTS",
    "FERRUM_ADMIN_SPEC_EXTERNAL_REFS_MAX_REFS",
    "FERRUM_ADMIN_SPEC_EXTERNAL_REFS_MAX_URI_LENGTH",
    "FERRUM_ADMIN_SPEC_EXTERNAL_REFS_REQUEST_TIMEOUT_MS",
    "FERRUM_ADMIN_SPEC_EXTERNAL_REFS_TOTAL_TIMEOUT_MS",
    ...
    "FERRUM_AUDIT_RETENTION_DAYS",
    "FERRUM_AUDIT_RETENTION_MAX_ROWS",
    ...
    "FERRUM_CP_DP_TRUST_ALLOW_UNBOUNDED_STALE",
    ...
    "FERRUM_CP_GRPC_MAX_STREAM_LIFETIME_SECONDS",
    ...
    "FERRUM_DB_FAILOVER_ALLOW_WRITES",
    ...
    "FERRUM_HTTP3_CONNECT_UDP_ENABLED",
    ...
    "FERRUM_LOG_DELIVERY_MAX_RETAINED_BYTES",
    "FERRUM_LOG_DELIVERY_MAX_TASKS",
    "FERRUM_LOG_LEVEL",
    "FERRUM_LOG_MAX_RECORD_BYTES",
    "FERRUM_LOG_REDACT_METADATA_KEYS",
    "FERRUM_LOG_SHUTDOWN_DRAIN_TIMEOUT_MS",
    "FERRUM_MAX_CONCURRENT_FAULT_DELAYS",
    ...
    "FERRUM_MESH_ALLOW_EPHEMERAL_JWT_KEY",
    "FERRUM_MESH_ALLOW_NO_CA",
    "FERRUM_MESH_ALLOW_STATIC_ID",
    "FERRUM_MESH_APP_PROBES",
    ...
    "FERRUM_MESH_CAPTURE_UDP_MIGRATION_TO",
    ...
    "FERRUM_MESH_CONFIG_REVISION_ADOPT_SECS",
    ...
    "FERRUM_MESH_JWT_SVID_TTL_SECONDS",
    ...
    "FERRUM_MESH_NODE_WAYPOINT_RELAY_POD_UID",
    "FERRUM_MESH_NODE_WAYPOINT_UDP_LISTENERS_ENABLED",
    ...
    "FERRUM_MESH_STOCK_XDS_NODE_METADATA",
    "FERRUM_MESH_STOCK_XDS_TOKEN_FILE",
    "FERRUM_MESH_STOCK_XDS_TOKEN_MAX_STREAM_LIFETIME_SECONDS",
    "FERRUM_MESH_STOCK_XDS_TOKEN_REFRESH_SKEW_SECONDS",
    ...
    "FERRUM_MESH_WORKLOAD_API_ENABLED",
    ...
    "FERRUM_MESH_WORKLOAD_API_SVID_TTL_SECONDS",
    ...
    "FERRUM_MONGO_CHANGE_STREAM_DEBOUNCE_MS",
    "FERRUM_MONGO_CHANGE_STREAM_ENABLED",
    ...
    "FERRUM_REQUEST_BUFFER_MAX_TOTAL_BYTES",
    "FERRUM_REQUEST_DECODE_MAX_TOTAL_BYTES",
    "FERRUM_RESPONSE_BUFFER_CUTOFF_BYTES",
    "FERRUM_RESPONSE_BUFFER_FALLBACK_MAX_BYTES",
    "FERRUM_RESPONSE_BUFFER_MAX_TOTAL_BYTES",
    "FERRUM_RESPONSE_COALESCE_FLUSH_MS",
    ...
    "FERRUM_SERVICE_DISCOVERY_STALE_POLICY",
    ...
    "FERRUM_STREAM_SNI_PLAINTEXT_FALLBACK",
    ...
    "FERRUM_TLS_STORE_MAX_DOCUMENT_BYTES",
    ...
    "FERRUM_UDP_MAX_SESSIONS_PER_IP",
    ...
    "FERRUM_WEBSOCKET_MAX_INCOMPLETE_MESSAGE_SECONDS",
    "FERRUM_WEBSOCKET_MAX_LIFETIME_SECONDS",
    "FERRUM_WEBSOCKET_TUNNEL_MODE",
    "FERRUM_WEBSOCKET_WRITE_BUFFER_SIZE",
    "FERRUM_WORKER_THREADS",
    "FERRUM_XDS_ALLOW_UNBOUNDED_STREAM_LIMITS",
    "FERRUM_XDS_ENABLED",
