...
/// |-----------|-------------|-------------------------------------------|---------|
/// | Early     | 0–949       | Pre-routing, tracing, and preflight       | otel_tracing (25), correlation_id (50), rate_limiting (90), cors (100), request_termination (125), mesh_outbound_registry (130), ip_restriction (150), bot_detection (200), sse (250), grpc_web (260), grpc_method_router (275), spiffe_identity (940) |
...
/// | AuthZ     | 2000–2999   | Authorization and admission control       | access_control (2000), tcp_connection_throttle (2050), mesh_authz (2075), request_size_limiting (2800), graphql (2850), ai_prompt_shield (2925), body_validator (2950), ai_request_guard (2975), ai_federation (2985) |
...
pub mod priority {
    ...
    pub const RATE_LIMITING: u16 = 90;
