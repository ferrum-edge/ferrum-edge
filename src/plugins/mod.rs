...
pub const BUILTIN_PLUGIN_REGISTRATIONS: &[PluginRegistration] = &[
    ...
    builtin_plugin("transaction_debugger", PluginFailurePolicy::OptionalFailOpen),
    ...
    builtin_plugin("request_transformer", PluginFailurePolicy::KeepLastKnownGood),
    builtin_plugin("response_transformer", PluginFailurePolicy::KeepLastKnownGood),
    ...
    builtin_plugin("serverless_function", PluginFailurePolicy::KeepLastKnownGood),
    ...
    builtin_plugin("api_chargeback", PluginFailurePolicy::OptionalFailOpen),
    builtin_plugin("api_chargeback_sink", PluginFailurePolicy::OptionalFailOpen),
