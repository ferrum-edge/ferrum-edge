...
pub use carrier::{
    ...
    FERRUM_ECDS_SERVICE_WAYPOINT_BOUND_SERVICES_TYPE_URL, FERRUM_ECDS_SERVICES_TYPE_URL,
    FERRUM_ECDS_SIDECAR_EGRESS_SCOPE_TYPE_URL, FERRUM_ECDS_TELEMETRY_TYPE_URL,
    FERRUM_ECDS_TRUST_BUNDLES_TYPE_URL, FERRUM_ECDS_VS_L4_PROXIES_TYPE_URL,
    FERRUM_ECDS_WAYPOINT_GATEWAY_CLASS_TYPE_URL, FERRUM_ECDS_WORKLOADS_TYPE_URL,
    MAX_SERVICE_WAYPOINT_BOUND_REF_LEN, MAX_SERVICE_WAYPOINT_BOUND_SERVICES_CARRIER_BYTES,
