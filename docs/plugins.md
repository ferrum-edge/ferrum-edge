...
Leading and trailing slashes are part of each protected query scalar and are never trimmed. A slash-only scalar remains governed and therefore causes ambiguous URL-path surfaces to fail closed rather than becoming an empty, unprotected value.
