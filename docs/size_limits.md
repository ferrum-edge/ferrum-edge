...
| `FERRUM_MAX_WEBSOCKET_FRAME_SIZE_BYTES` | `usize` | `16777216` (16MB) | Maximum WebSocket frame size in bytes. Also sets max message size to 4x frame size. Global (and plugin) parser overflows close both peers with RFC 6455 **1009**. |
