...
- the shared JWKS trust/failure families (`ferrum_jwks_*`)
...
simply wrong by however long the cache has been held. The same applies to
`ferrum_jwks_trust_age_seconds` and its automatic fresh/grace/expired
transition.
