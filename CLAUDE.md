...
1. `on_request_received` — OTel tracing (25), correlation ID (50), CORS preflight (100), request termination (125), IP restriction (150), geo restriction (175), bot detection (200), spec expose (210), SSE validation (250), gRPC-Web translation (260), gRPC method router (275)
