...
├── plugins/                   # Plugin system (44 plugins, including 4 AI/LLM, 1 serverless, 1 compression, 1 SSE, 3 gRPC, 3 WS frame, 1 WS logging, 1 UDP datagram, and 1 Loki logging plugin)
...
9. `log` — Stdout logging (9000), StatsD logging (9075), HTTP logging (9100), Loki logging (9150), WebSocket logging (9175), transaction debugger (9200, `tracing::debug` on `transaction_debug` target), Prometheus (9300), OTel tracing (25)
