...
async fn test_registry_render_contains_expected_metrics() {
    ...
    assert!(output.contains("# HELP ferrum_compression_response_buffer_admitted_total"));
    assert!(output.contains("# TYPE ferrum_compression_response_buffer_admitted_total counter"));
    assert!(output.contains("# HELP ferrum_compression_response_buffer_saturated_total"));
    assert!(output.contains("# TYPE ferrum_compression_response_buffer_saturated_total counter"));
