...
- **41 built-in plugins**: Authentication, authorization, rate limiting, compression, SSE stream handling, transformation, serverless functions, AI/LLM-specific plugins, and observability
