...
- **44 built-in plugins**: Authentication, authorization, rate limiting, compression, SSE stream handling, transformation, serverless functions, AI/LLM-specific plugins, and observability
...
| **Logging** (9000-9999) | `stdout_logging` (9000), `ws_frame_logging` (9050), `statsd_logging` (9075), `http_logging` (9100), `loki_logging` (9150), `ws_logging` (9175), `transaction_debugger` (9200), `prometheus_metrics` (9300) |
