...
mod ferrum_release_on_close_tests {
    ...
    mod pooled_http1 {
        use super::super::{
            await_pooled_response, pool, poll_h1_dispatch_open, release_pool_conn,
            ConnTrySendError, Connected, ErrorKind, PoolClient, PoolConn, PoolKey, PoolTx,
            Request, Response, TrySendError, Ver,
        };
