...
- PR CI runs format, tests in parallel, lint, path-gated perf regression for performance-sensitive changes, and five build targets: Linux x86_64/ARM64, macOS x86_64/ARM64, Windows x86_64.
