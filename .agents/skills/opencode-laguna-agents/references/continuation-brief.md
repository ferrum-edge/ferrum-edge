# Ferrum Edge opencode continuation brief
...
any agent-dispatch skill or script, including `opencode-agents`, `grok-agents`, `astra-agents`, `sol-agents`, `luna-agents`,
`opus-agents`,
`fable-5-1-agents`, `.agents/skills/*/scripts/dispatch-agent.sh`, Codex CLI workers, or Claude CLI
